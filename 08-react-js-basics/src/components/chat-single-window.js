...
export const ChatSingleWindow = () => {
    ...
    const userById = chatList.find(user => user.chatListId === Number(chatId));
    const chatFiltered = messageList.filter(message => (message.messageListName === userById.chatListName) || (message.messageListBody === `This is a bot reply to ${userById.chatListName}. That message was generated by Firebase in three seconds.`));
