...
export const fbMessageListAddUser = (messageName, messageBody) =>
    async () => {
        const message = {
...
export const fbMessageListAddBot = (messageName) =>
    async () => {
        const botMessage = {
            messageListName: "Bot",
...
export const fbMessageListFetchStoreUpdate = () => {
    return (dispatch, getState) => {
        firebase.database().ref("messageList").on("value", (snapshot) => {
            const fbMessageList = [];
